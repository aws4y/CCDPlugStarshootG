...
#define STARSHOOTG_TEC_TARGET_MIN           (-300)  /* TEC target: -30.0 degrees Celsius */
#define STARSHOOTG_TEC_TARGET_DEF           0       /* 0.0 degrees Celsius */
#define STARSHOOTG_TEC_TARGET_MAX           300     /* TEC target: 30.0 degrees Celsius */
...
STARSHOOTG_API(HRESULT)  Starshootg_StartPullModeWithCallback(HStarshootg h, PSTARSHOOTG_EVENT_CALLBACK pEventCallback, void* pCallbackCtx);
...
STARSHOOTG_API(HRESULT)  Starshootg_StartPushModeV3(HStarshootg h, PSTARSHOOTG_DATA_CALLBACK_V3 pDataCallback, void* pDataCallbackCtx, PSTARSHOOTG_EVENT_CALLBACK pEventCallback, void* pEventCallbackCtx);
...
/* discard the current internal frame cache.
    ...
    Starshootg_Flush is obsolete, it's a synonyms for Starshootg_put_Option(h, STARSHOOTG_OPTION_FLUSH, 3)
*/
...
#define STARSHOOTG_OPTION_FRONTEND_DEQUE_LENGTH  0x31       /* frontend frame buffer deque length, range: [2, 1024], default: 4 */
...
#define STARSHOOTG_OPTION_BACKEND_DEQUE_LENGTH   0x41       /* backend frame buffer deque length (Only available in pull mode), range: [2, 1024], default: 3 */
...
#define TOUCPAM_OPTION_EVENT_HARDWARE         0x04000000 /* enable or disable hardware event: iOption = TOUCPAM_OPTION_EVENT_HARDWARE | (event type), iValue = 1 (enable), 0 (disable); default: disable */
