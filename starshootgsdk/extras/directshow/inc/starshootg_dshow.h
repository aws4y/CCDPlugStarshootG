#ifndef __starshootg_dshow_h__
#define __starshootg_dshow_h__

/* Version: 50.19915.20211127 */
...
typedef void (__stdcall* PISTARSHOOTG_EXPOSURE_CALLBACK)(void* pCtx);                                      /* exposure time or gain changed */
...
#ifndef __ISTARSHOOTG_DEFINED__
#define __ISTARSHOOTG_DEFINED__
    /* Both the DirectShow source filter and the output pin(s) support this interface.
        That is to say, you can use QueryInterface on the filter or the pin(s) to get the IStarshootg interface.
    */
    // {66B8EAB5-B594-4141-95FC-691A81B445F6}
    DEFINE_GUID(IID_IStarshootg, 0x66b8eab5, 0xb594, 0x4141, 0x95, 0xfc, 0x69, 0x1a, 0x81, 0xb4, 0x45, 0xf6);

    DECLARE_INTERFACE_(IStarshootg, IUnknown)
    {
        /*
        ...
        */
        ...
        STDMETHOD(GetHistogram) (THIS_ PISTARSHOOTG_HISTOGRAM_CALLBACK fnHistogramProc, void* pHistogramCtx) PURE;            
        STDMETHOD(put_ExpoCallback) (THIS_ PISTARSHOOTG_EXPOSURE_CALLBACK fnExpoProc, void* pExpoCtx) PURE;
        ...
        STDMETHOD(AwbInit) (THIS_ PISTARSHOOTG_WHITEBALANCE_CALLBACK fnWBProc, void* pWBCtx) PURE;
        ...
        */
        ...
        STDMETHOD(put_ChromeCallback) (THIS_ PISTARSHOOTG_CHROME_CALLBACK fnChromeProc, void* pChromeCtx) PURE;
        ...
        STDMETHOD(AwbOnce) (THIS_ PISTARSHOOTG_TEMPTINT_CALLBACK fnTTProc, void* pTTCtx) PURE;
        ...
        */
        ...
        STDMETHOD(AbbOnce) (THIS_ PISTARSHOOTG_BLACKBALANCE_CALLBACK fnBBProc, void* pBBCtx) PURE;
        ...
        */
        ...
        STDMETHOD(get_FfcStatus) (THIS_ int* status) PURE; /* see STARSHOOTG_OPTION_FFC */
        ...
        STDMETHOD(get_DfcStatus) (THIS_ int* status) PURE; /* see STARSHOOTG_OPTION_DFC */
        ...
        */
        ...
        STDMETHOD(get_AfParam) (THIS_ StarshootgAfParam* pAfParam) PURE;
...
#ifndef __ISTARSHOOTGSTILLIMAGE_DEFINED__
#define __ISTARSHOOTGSTILLIMAGE_DEFINED__
    /* most Orion Camera DirectShow source filters has two output pins, one is pin category PIN_CATEGORY_PREVIEW, and the other is pin category PIN_CATEGORY_STILL.
    ...
    */
    ...
    DEFINE_GUID(IID_IStarshootgStillImage, 0xe978eea0, 0xa0ff, 0x465f, 0xab, 0x35, 0x65, 0x90, 0x7b, 0x8c, 0x62, 0xac);
    
    DECLARE_INTERFACE_(IStarshootgStillImage, IUnknown)
    {
        /*
...
#ifndef __ISTARSHOOTGSERIALNUMBER_DEFINED__
#define __ISTARSHOOTGSERIALNUMBER_DEFINED__
    // {E12D4B13-333F-4eae-BC89-0446D1FC634D}
    DEFINE_GUID(IID_IStarshootgSerialNumber, 0xe12d4b13, 0x333f, 0x4eae, 0xbc, 0x89, 0x4, 0x46, 0xd1, 0xfc, 0x63, 0x4d);
    
    DECLARE_INTERFACE_(IStarshootgSerialNumber, IUnknown)
    {
        /*
...
#ifndef __ISTARSHOOTGVERSION_DEFINED__
#define __ISTARSHOOTGVERSION_DEFINED__

    // {FC69B0C7-6140-4FE7-B385-473E5EA87887}
    DEFINE_GUID(IID_IStarshootgVersion, 0xfc69b0c7, 0x6140, 0x4fe7, 0xb3, 0x85, 0x47, 0x3e, 0x5e, 0xa8, 0x78, 0x87);
    
    DECLARE_INTERFACE_(IStarshootgVersion, IUnknown)
    {
        /*
...
#ifndef __ISTARSHOOTGST4_DEFINED__
#define __ISTARSHOOTGST4_DEFINED__

    /* Please see: ASCOM Platform Help ICameraV2 */
    // {29867037-78A9-432F-BF33-A3CFE0D6C9B3}
    DEFINE_GUID(IID_IStarshootgST4, 0x29867037, 0x78a9, 0x432f, 0xbf, 0x33, 0xa3, 0xcf, 0xe0, 0xd6, 0xc9, 0xb3);
    
    DECLARE_INTERFACE_(IStarshootgST4, IUnknown)
    {
...
#ifndef __ISTARSHOOTGINDEX_DEFINED__
#define __ISTARSHOOTGINDEX_DEFINED__

    // {F670E70F-FDD0-4131-BAF7-E7F6C3EB66CF}
    DEFINE_GUID(IID_IStarshootgIndex, 0xf670e70f, 0xfdd0, 0x4131, 0xba, 0xf7, 0xe7, 0xf6, 0xc3, 0xeb, 0x66, 0xcf);
    
    DECLARE_INTERFACE_(IStarshootgIndex, IUnknown)
    {
...
void InitAx()
{
    ...
    HKEY hKey = NULL;
    /* {EA6387A5-60C7-41D3-B058-8D90580A7BE1} is the clsid of starshootg dshow object */
    if (ERROR_SUCCESS == RegOpenKeyExW(HKEY_CLASSES_ROOT, L"CLSID\\{EA6387A5-60C7-41D3-B058-8D90580A7BE1}\\InprocServer32", 0, KEY_READ, &hKey))
    {
        ...
        if (ERROR_SUCCESS == RegQueryValueExW(hKey, NULL, NULL, NULL, (PBYTE)axPath, &cbData)) /* query the full path of starshootg.ax */
        {
