...
IMAGEPRO_API(HImageproStitch) imagepro_stitch_newV2(eImageproFormat format, bool bGlobalShutter, int videoW, int videoH, IMAGEPRO_STITCH_CALLBACK pFun, IMAGEPRO_STITCH_ECALLBACK pEFun, void* ctx);
...
IMAGEPRO_API(HRESULT) imagepro_stitch_pull(HImageproStitch handle, HStarshootg h, bool bFeed, void* pImageData, int bits, int rowPitch, StarshootgFrameInfoV2* pInfo);
#endif
...
IMAGEPRO_API(HRESULT) imagepro_edf_pull(HImageproEdf handle, HStarshootg h, bool bFeed, void* pImageData, int bits, int rowPitch, StarshootgFrameInfoV2* pInfo);
#endif
